        ...
        <div class="container-fluid  col-md-6 text-center">            
            <nav class="navbar navbar-light bg-faded" >                
                <form class="form-inline " >
                    ...
                    <a href="consultar.jsp"><button class="btn btn-outline-success btn-lg active" type="button" active >Consultar </button></a>
        ...
        <form action="<%=request.getContextPath()%>/cproyectostb" method="get"  >
            <div class="container-fluid  col-md-10 ">  
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="id" class="form-control" name="id" value="<%=(project != null) ? project.getId() : " "%>"placeholder="Aqui ID" required>
                    </div>          
                </div>
            </div>
            <div class="container-fluid  col-md-10 ">  
